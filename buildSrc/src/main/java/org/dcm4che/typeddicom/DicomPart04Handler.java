...
import org.dcm4che.typeddicom.table.Table;
import org.dcm4che.typeddicom.table.TableCell;
...
public class DicomPart04Handler extends MemorizeTablesDicomPartHandler {
    ...
    public String getBaseHrefUrl() {
        return AbstractDicomPartHandler.DICOM_STANDARD_HTML_URL + "/part04.html";
    }
